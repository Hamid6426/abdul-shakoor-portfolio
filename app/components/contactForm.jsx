...
const ContactForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setStatus("Sending...");
    try {
      await axios.post("/mails/post-mail", {
        firstName,
        lastName,
        email,
        subject,
  ...
  return (
    <div className="mt-8 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full py-3 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300 transition duration-200"
        >
          Send Message
        </button>
      </form>
