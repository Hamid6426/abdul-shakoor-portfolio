...
const ProjectsPage = () => {
  // Enhanced project data with details, images, and links
  const projects = [
    {
    ...
    {
      title: "Sustainable Horizons: Green Future",
      description: "Dr. Shakoor organized and participated in the workshop 'Sustainable Horizons, Designs & Practices for Green Future' to explore sustainable engineering practices and innovations.",
      image: "https://www.uetpeshawar.edu.pk/images/workshop_image.jpg", // Replace with actual image
      link: "https://www.facebook.com/UETPeshawarOfficial/videos/a-one-day-workshop-on-sustainable-horizons-designs-practices-for-green-future-wa/772738394225537/?utm_source=chatgpt.com"
    }
  ];
